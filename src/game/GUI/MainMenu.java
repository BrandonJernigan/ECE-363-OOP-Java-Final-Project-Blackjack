...
public class MainMenu extends JFrame {
	...
	public MainMenu(String playerName) {
		...
		ImageIcon imageIcon2 = new ImageIcon(new ImageIcon(MainMenu.class.getResource("/game/graphics/backdrops/title_medavoych.jpg")).getImage().getScaledInstance(w/4, h/4, Image.SCALE_DEFAULT));
